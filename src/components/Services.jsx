          ...
          <section className='pt-24 pb-16 bg-white' id='services'>
               <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    ...
                    <div className='flex flex-col md:flex-row gap-4 mb-12 md:w-2/3'>
                         ...
                         <div className=''>
                              <p className='text-secondary'>At our digital marketing agency we offer a range of service to help buisnesses grow in different pace and priorities</p>
                         </div>
                    </div>
                                   ...
                                   <div key={index} className={`flex flex-col sm:flex-row md:justify-between md:items-center gap-6 p-6 rounded-lg border border-[#191a23] cursor-pointer ${service.backgroundColor} ${service.textColor}`}>
                                        ...
                                        <div className='md:w-1/2 flex flex-col h-full justify-between'>
                                             ...
                                             <a href="#" className={`flex items-center gap-4 py-2 rounded-md text-black hover:bg-opacity-80 hover:text-black/80`}>
                                                  <img src={LinkIcon} alt="" className='size-8 rounded-full' />
                                                  <span className='text-lg md:text-xl font-medium'>Learn More</span>
                                             </a>
                                        </div>
